...
This tutorial details the prerequisites and installation process for the open-source help desk ticketing system, osTicket.<br />
...
- Create a Windows 10 Virtual Machine (VM) with 2 Virtual CPUs minimum within the Resource Group you created
...
<p>
After completing the prerequisites above, open your Microsoft Azure Windows 10 virtual machine using "Remote Desktop Connection." Just copy and paste your virtual machine's public IP address, then log in with the username and password you set up in Azure.
</p>
<p>
<img src="https://i.imgur.com/J0Z5fuG.png">
</p>
<br />

<p>
Next, we need to install and enable Internet Information Services (IIS) in Windows with CGI. To do this, open the Control Panel, click on "Programs," and then select "Turn Windows features on or off." Check the necessary features as shown in one of the images below, following this order: "World Wide Web Services" -> "Application Development Features" -> check "CGI," and then click "OK."

Once the installation is complete, open Microsoft Edge, enter 127.0.0.1 in the search bar, and press Enter. If the IIS page appears, it means everything was installed correctly.
</p>
<p>
...
<img src="https://i.imgur.com/86LzTvW.png">
</p>
...
<img src="https://i.imgur.com/Q1iiNPq.png">
